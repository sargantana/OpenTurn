...
#define CY_CFG_SYSCLK_ECO_FREQ 32000000UL
...
#define CY_CFG_SYSCLK_ECO_CLOAD 12UL
...
#define CY_CFG_SYSCLK_CLKPUMP_SOURCE CY_SYSCLK_PUMP_IN_CLKPATH0
...
__WEAK void __NO_RETURN cycfg_ClockStartupError(uint32_t error)
{
	...
	__STATIC_INLINE void Cy_SysClk_EcoInit()
	{
	    ...
	    if (CY_SYSCLK_BAD_PARAM == Cy_SysClk_EcoConfigure(CY_CFG_SYSCLK_ECO_FREQ, 12UL, 50UL, 100UL))
	    {
