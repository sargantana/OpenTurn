...
"""
    ...
    Sorted By: Ref
    Fields: Ref, Qnty, Value, Cmp name, Footprint, Description, Vendor, Spec
...
out.writerow(['Ref', 'Qnty', 'Value', 'Cmp name', 'Footprint', 'Description', 'Spec', 'Vendor'])
...
for group in grouped:
    ...
    out.writerow([refs, len(group),
        ...
        fromNetlistText( c.getField("Spec") ),
